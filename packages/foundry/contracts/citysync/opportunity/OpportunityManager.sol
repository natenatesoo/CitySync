...
contract OpportunityManager is AccessControl, Pausable, ReentrancyGuard, EIP712 {
    ...
    constructor(address admin, CityToken city, VoteToken vote) EIP712("CitySyncOpportunityManager", "1") {
        CITY = city;
        VOTE = vote;
    ...
    ) external onlyRole(CERTIFIED_ISSUER_ROLE) returns (uint256 opportunityId) {
